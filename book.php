...
<!--[if IE 6]><style type="text/css"> * html img { behavior: url("#") }</style><![endif]-->
...
<!--	<div id="header">-->
    <div>
		...
		<li><a class="fa fa-home" href="index.php">Home</a></li>
              <li><a class="fas fa-server" href="about.php">About</a></li>
              <li><a class="fa fa-server" href="services.php">Services</a></li>
              <li><a class="fas fa-server" href="routes.php">Routes</a></li>
              <li><a class="fas fa-map-marker" href="location.php">location</a></li>
              <li><a class="fa fa-phone-square" href="contact.php"> Contact</a></li>
			  <li> <a href="book.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">book</span>
          now</a></li>
          </ul>
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    <li class="show"><img src="xres/images/jb2/seat1.jpeg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/05.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/03.jpeg" width="861" height="379"  alt="" /></li>
	...
	<div id="footer">
	<h4>+254-768976971 &bull; <a href="contact.php">kitui town, Nairobi, Machakos town  </a></h4>
	<p>Hours of Operation&nbsp;&nbsp;&bull;&nbsp;&nbsp;Mon - Sun: 6:00 am - 6:00 pm</p>
	<a href="home.php"><img src="xres/images/footer-log.jpg" alt="Madocho Sacco" /></a>
