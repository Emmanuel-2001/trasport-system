...
$contact = createRandomPassword();
$fullName=$_POST['fullName'];
$phoneNumber=$_POST['phoneNumber'];
$subject=$_POST['subject'];
$message=$_POST['message'];
$result = mysqli_query($conn,"SELECT * FROM contact WHERE id='$fullName'");

mysqli_query($conn,"INSERT  INTO  contact  (`FullName`, `PhoneNumber`, `subject`, `message`)
